...
void ssd1306_swap(int16_t& a, int16_t& b) { int16_t t = a; a = b; b = t; }
...
void Adafruit_SSD1306_Core::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  ...
  uint8_t contrast = extvcc ? 0x9F : 0xCF;
#elif defined SSD1306_96_16
  uint8_t compins = 0x2;  //ada x12
  uint8_t contrast = extvcc ? 0x10: 0xAF;
#endif
